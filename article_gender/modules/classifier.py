...
class ArticleClassifier(nn.Module):
    ...
    def forward(self, x_article, apply_softmax=False):
        """The forward pass of the classifier

        Args:
            x_article (torch.Tensor): an input data tensor.
                x_article.shape should be
                (batch, initial_num_channels, max_surname_length)
